        ...
        <div class="section no-pad-bot" id="no-padding-top">
            ...
            <div class="row">
                ...
                <div id="location" class="col s12">
                    ...
                    <table>
                        <thead>
                            <th data-field="id">Hotel Name</th>
                    ...
                    <a href="https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={{ $LatLng }}&radius=1500&types=lodging&key=AIzaSyBFaySDzqmlKyFwdG9qGWxGD3rjM1Ub0Bg">Places</a>
